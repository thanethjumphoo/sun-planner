...
exports.BilWeightDistributionController = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const bil_weight_distribution_entity_1 = require("./bil-weight-distribution.entity");
let BilWeightDistributionController = class BilWeightDistributionController {
    wdRepo;
    constructor(wdRepo) {
        this.wdRepo = wdRepo;
    }
...
exports.BilWeightDistributionController = BilWeightDistributionController;
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BilWeightDistributionController.prototype, "getAll", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], BilWeightDistributionController.prototype, "bulkSave", null);
exports.BilWeightDistributionController = BilWeightDistributionController = __decorate([
    (0, common_1.Controller)('api/bil-weight-distribution'),
    __param(0, (0, typeorm_1.InjectRepository)(bil_weight_distribution_entity_1.BilWeightDistribution)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], BilWeightDistributionController);
//# sourceMappingURL=bil-weight-distribution.controller.js.map